...
import { User, LayoutDashboard, ClipboardList, LogOut } from 'lucide-react'; // Import LogOut icon

const SupervisorNav = () => {
  const navigate = useNavigate(); // Initialize useNavigate hook

  // Define the navigation items for the supervisor
  const navItems = [
  ...
  const handleLogout = () => {
    ...
    //    Example: localStorage.removeItem('supervisorAuthToken');
